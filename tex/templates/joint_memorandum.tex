...
\renewcommand{\printLetterhead}{%
    \begin{center}
        ...
        {\fontsize{8pt}{9pt}\selectfont
            ...
            \ifdefempty{\CommonLocation}{}{\\
            \MakeUppercase{\CommonLocation}}%
        }
    \end{center}
    % One line of space below letterhead per SECNAV M-5216.5
    \vspace*{12pt}%
}
...
\newcommand{\printAddressBlock}{%
    ...
    \begin{tabular}[t]{@{}l@{}p{5.75in}@{}}%
        From:\hspace{2\fontdimen2\font} & \SeniorFromLine\tabularnewline
