...
%=============================================================================
%              SSIC / SERIAL / DATE BLOCK (Right-aligned, raggedleft)
%=============================================================================

\newcommand{\printDateAndTitle}{%
    \begingroup
    \applyDocumentFontSize
    % SSIC block right-positioned, left-aligned per SECNAV M-5216.5 Ch 7 Section 3:
    % "The longest line of the sender's symbol should end close to the right margin."
    % \hfill pushes the block right; {l} left-aligns content within it.
    \hfill
    \begin{tabular}[t]{@{}l@{}}
