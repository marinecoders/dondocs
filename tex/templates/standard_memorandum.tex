...
% \MemorandumForAddressee and \setMemorandumForAddressee defined in main.tex
% (before \input{document}) so document.tex can use them.
...
\newcommand{\printDateAndTitle}{%
    ...
    \ifDistributionEnabled
        \noindent MEMORANDUM FOR: SEE DISTRIBUTION\par
        \vspace{12pt}%
    \else
