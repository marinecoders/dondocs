...
`;
  ...
  if (data.classLevel === 'custom' && data.customClassification) {
    const customUpper = data.customClassification.toUpperCase();

    // Check if custom contains CUI (but not CONFIDENTIAL which also has "C-U-I" pattern)
    if (customUpper.includes('CUI') && !customUpper.includes('CONFIDENTIAL')) {
      return `%=============================================================================
% CUSTOM CUI CONFIGURATION - Generated by libo-secured
%=============================================================================
...
`;
    ...
    // For CONFIDENTIAL or other custom classifications, use classified formatting
    return `%=============================================================================
% CUSTOM CLASSIFICATION CONFIGURATION - Generated by libo-secured
%=============================================================================
