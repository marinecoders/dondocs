...
export const humanitarianTransfer: LetterTemplate = {
  ...
  paragraphs: [
    ...
    { text: 'Requested Location. I request assignment to [GEOGRAPHIC AREA/SPECIFIC DUTY STATION] to be within reasonable driving distance of affected family member. Units in the area that could utilize my MOS include those at: [SPECIFIC RECEIVING UNIT(s) AT DUTY STATION].', level: 0 },
