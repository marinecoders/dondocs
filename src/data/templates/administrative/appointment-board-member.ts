...
export const appointmentBoardMember: LetterTemplate = {
  ...
  paragraphs: [
    { text: 'Appointment. Per reference (a), you are hereby appointed as a [VOTING MEMBER/RECORDER/PRESIDENT] of the [BOARD/COMMITTEE NAME] convening on [DATE] at [TIME] in [BUILDING], [LOCATION].', level: 0 },
