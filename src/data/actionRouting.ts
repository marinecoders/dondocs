...
export const ACTION_ROUTING: readonly ActionRoute[] = [
  ...
  },
  {
    ...
    destination: 'Your S-1 / unit board; HQMC MMPR for HQMC-level',
    note: 'Local promotions run through the S-1/unit board; HQMC MMPR-2 (enlisted) / MMPR-1 (officer) for HQMC-level.',
    authority: 'HQMC Manpower Management (MMPR)',
    level: 'hqmc',
  },
  {
    id: 'awards',
  ...
  },
  {
    ...
    note: 'OMPF/records corrections route to HQMC MMSB; formal corrections may need the BCNR.',
    authority: 'IRAM (MCO 1070.12K)',
    level: 'hqmc',
  },
  {
    id: 'fitrep',
    ...
    destination: 'Your S-1; HQMC Performance Branch (MMPB) for processing',
    note: 'Fitness reports are submitted through the S-1; HQMC MMPB processes them into the record.',
    authority: 'MCO 1610.7',
    level: 'hqmc',
  },
  {
    id: 'subsistence',
  ...
  },
  {
    ...
    keywords: ['njp', 'legal', 'court-martial', 'court martial', 'article 15', 'admin sep', 'administrative separation', '6105'],
